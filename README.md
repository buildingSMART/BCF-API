...
- [3. BCF Services](#3-bcf-services)
  ...
  - [3.2 Topic Services](#32-topic-services)
    ...
    - [3.2.8 Including Topic Relations when Returning Topics](#328-including-topic-relations-when-returning-topics)
  ...
  - [3.5 Viewpoint Services](#35-viewpoint-services)
    ...
    - [3.5.2 POST Viewpoint Service](#352-post-viewpoint-service)
      ...
      - [3.5.2.3 Camera](#3523-camera)
        - [3.5.2.3.1 Orthogonal Camera](#35231-orthogonal-camera)
        - [3.5.2.3.2 Perspective Camera](#35232-perspective-camera)
